            ...
            <div class="x_content">
              <table id="datatable" class="table table-striped table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>{{$i}}</td>
                    <td>{!! getImagesList($element['image']) !!}</td>
                    <td>
                      <?php
...
?>
                    ...
                    <td style="width: 10%" data-name='other' data-id={{$element["id"]}}>
                      <a href="{{ route('admin.other.deleteNews',$element["id"])}}" title="Xóa" onclick="return xoa('Bạn chắc chắn muốn xóa')" ><i class="fa fa-trash"></i></a>
