    ...
    <div class="x_content">
      <div class="" role="tabpanel" data-example-id="togglable-tabs">
        ...
        <div role="tabpanel" class="tab-pane fade" id="add" aria-labelledby="profile-tab">
          <div class="x_content">
            <br />
            <form id="add_cat" action="{{route('admin.slide.add_header')}}" class="form-horizontal" method="post" enctype="multipart/form-data" onsubmit="return validateFile()">
              ...
              <div class="form-group has-feedback">
                ...
                <label for="image" class="uploadimg">
                  ...
                  <input id="image" class="hide" type="file" name="hinhanh" />
