                ...
                <form id="add_user"  class="form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select class="form-control" name="cat_id">
                                ...
                                @php(cat_parent($parent, 0, "-", $arEdit["cat_id"]))
                            </select>
                        </div>
                    </div>
                    <div class="form-group has-feedback">
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <label for="image" class="uploadimg">
                            <div id="anhxoa" class="hidden"></div>
                            <img id="datafile" src="{{ asset('images/' . $arEdit['images']) }}" data-img="{{getenv('FILE_UPLOAD')}}" />
