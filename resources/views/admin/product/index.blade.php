              ...
              <table id="datatable" class="table table-striped table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{!! getImagesList($element['images']) !!}
                    </td>
            ...
            <div class="x_content">
              ...
              <div class="well">
                ...
                <div class="form-group has-feedback">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text"  name="price" class="form-control col-md-7 col-xs-12"><i class='glyphicon glyphicon-ok form-control-feedback'></i>
                  </div>
                </div>
                <div class="form-group has-feedback">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text"  name="sale" class="form-control col-md-7 col-xs-12" placeholder="%" >
                ...
                <div class="form-group has-feedback">
                  ...
                  <label for="image" class="uploadimg">
                    ...
                    <img id="datafile" src="{{ asset('/templates/admin/images/image.png') }}" data-img="{{ asset('/templates/admin/images/image.png') }}" />
