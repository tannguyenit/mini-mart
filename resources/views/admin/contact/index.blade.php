...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2><i class="fa fa-bars"></i> Quản lý liên hệ</h2>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width: 10%" data-name='contact' data-id={{$element["id"]}}>
                                ...
                                <a style="cursor:pointer" class="edit" data-toggle="modal" data-target=".bs-example-modal-lg" title="Sửa" id="del">
