            ...
            <div class="container clearfix">
                ...
                <div class="top_search col-md-9 col-xs-12">
                        ...
                        @if (Cart::content()->count())
                            <div class="top-cart-content">
                                ...
                                <div class="top-cart-action clearfix">
                                    <span class="fleft top-checkout-price">{{ Cart::subtotal() }} VND</span>
                    ...
                    <a class='top_hotline col-sm-3 hidden-sm hidden-xs nopadding' href='tel:19001267'>
                        <img alt='' src='{{ asset('images/top_hotline.png') }} ' />
                    </a>
                </div>
            </div>
            <div class="span4 pull-right" style="position: absolute;top: 90px;right: 0;">
                        ...
                        @if ($value['parent_id'] == 0)
                            <li class=" menu">
                                <a class="menu" href="{{ route('product.indexCat',[str_slug($value['name']), $value['id']]) }}">
                                    <img alt="{{$value['name']}}" src="{{ asset('images/' . $value['icon']) }}">
                                    <span class="menu_title">{{$value['name']}}</span>
                                    {!!$right!!}
                                </a>
            ...
            <ul class="sf-js-enabled">
                    ...
                    <a href="{{ route('index.index') }}">
                        <div>
                            <div class="menu_icon hidden-xs hidden-sm">
                                <img alt="Trang chủ" src="{{ asset('images/main_menu_icon_1.png') }}">
                            </div> Trang chủ
                        </div>
                    </a>
                </li>
                <li>
                    <a href="{{ route('product.all') }}">
                        <div>
                            <div class="menu_icon hidden-xs hidden-sm">
                                <img alt="Sản phẩm" src="{{ asset(('images/main_menu_icon_2.png')) }}">
                            </div> Sản phẩm
                        </div>
                    </a>
                </li>
                <li>
                    <a href="{{ route('news.index') }}">
                        <div>
                            <div class="menu_icon hidden-xs hidden-sm">
                                <img alt="Tin tức" src="{{ asset('images/main_menu_icon_3.png') }}">
                            </div> Tin tức
                        </div>
                    </a>
                </li>
                <li>
                    <a href="{{ route('intro.index') }}">
                        <div>
                            <div class="menu_icon hidden-xs hidden-sm">
                                <img alt="Giới thiệu" src="{{ asset('images/main_menu_icon_4.png') }}">
                            </div> Giới thiệu
                        </div>
                    </a>
                </li>
        ...
        <section id="slider" class="nopadding ohidden clearfix  slide_80  slick-initialized slick-slider">
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="item">
                        <img src="{{ asset('images/' . $element['image']) }}" alt="Chania" width="775" height="400">
                    </div>
                    @endforeach
                </div>
            </div>
            <button class="left carousel-control slick-prev slick-arrow" href="#myCarousel" role="button" data-slide="prev" type="button"  style="display: block;">
                <i class="fa fa-angle-left"></i>
            </button>
            <button class="right carousel-control slick-next slick-arrow" href="#myCarousel" role="button" data-slide="next" type="button"  style="display: block;">
                <i class="fa fa-angle-right"></i>
            </button>
        </section>
        <div class="banner_top nopadding hidden-sm hidden-xs">
            <a href="http://minimart/gia-dung">
                <img alt="/gia-dung" src="{{ asset('images/banner_top_1.jpg') }}">
            </a>
            <a href="http://minimart/tin-hoc">
                <img alt="/tin-hoc" src="{{ asset('images/banner_top_2.jpg') }}">
            </a>
        </div>
        @endif
    </div>
