<div class="modal-dialog modal-md">
  <div class="modal-content">
    ...
    <div class="modal-body">
      <form id="edit_cat" action="{{route('admin.other.edit')}}" class="form-horizontal" method="post" enctype="multipart/form-data" >
      ...
      <div class="form-group has-feedback">
        ...
        <label for="image2" class="uploadimg">
          <?php 
          if ($arEdit['image']!='') {
            $url=$_SERVER['DOCUMENT_ROOT'].'/'.getenv('STORAGE').'/'.$arEdit['image'];
            if (file_exists($url)) {
              $picture=getenv('STORAGE').'/'.$arEdit['image'];
            }else{
