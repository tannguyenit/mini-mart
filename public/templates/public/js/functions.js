	...
	var lazyLoad = function() {
		...
		if( lazyLoadEl.length > 0 ) {
			lazyLoadEl.each( function(){
				...
				element.attr('src', '//bizweb.dktcdn.net/100/052/691/themes/208078/assets/blank.svg?1482160188435').css({ 'background': 'url(//bizweb.dktcdn.net/100/052/691/themes/208078/assets/preloader.gif?1482160188435) no-repeat center center #FFF' });
