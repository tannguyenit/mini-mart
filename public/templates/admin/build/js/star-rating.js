...
! function(e) {
    ...
    t = ".rating", a = 0, n = 5, r = .5, i = function(t, a) {
        ...
        _starClick: function(e) {
           ...
           // var id = $(this).closest('.rating');
            var id = a.$element.closest('td').attr('data-id');
            var star=a.$element.val();
            var id_user=$("#id_user").val();
            $.post('/admin/admin_assets/danhgiataisan', {id:id,star:star,id_user:id_user}, function(data, textStatus, xhr) {
                console.log(data)
            });
